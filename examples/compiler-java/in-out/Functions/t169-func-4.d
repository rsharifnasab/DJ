...
void test(int a1, int a2, int a3, int a4, int a5, int a6, int a7, int a8, int a9, int a10,
    ...
    Print("args: ", a15, " ", a72, " ", a100);
}

int main() {
    test(ReadInteger(), ReadInteger(), ReadInteger(), ReadInteger(), ReadInteger(), ReadInteger(), ReadInteger(), ReadInteger(), ReadInteger(), ReadInteger(),
         ReadInteger(), ReadInteger(), ReadInteger(), ReadInteger(), ReadInteger(), ReadInteger(), ReadInteger(), ReadInteger(), ReadInteger(), ReadInteger(),
         ReadInteger(), ReadInteger(), ReadInteger(), ReadInteger(), ReadInteger(), ReadInteger(), ReadInteger(), ReadInteger(), ReadInteger(), ReadInteger(),
         ReadInteger(), ReadInteger(), ReadInteger(), ReadInteger(), ReadInteger(), ReadInteger(), ReadInteger(), ReadInteger(), ReadInteger(), ReadInteger(),
         ReadInteger(), ReadInteger(), ReadInteger(), ReadInteger(), ReadInteger(), ReadInteger(), ReadInteger(), ReadInteger(), ReadInteger(), ReadInteger(),
         ReadInteger(), ReadInteger(), ReadInteger(), ReadInteger(), ReadInteger(), ReadInteger(), ReadInteger(), ReadInteger(), ReadInteger(), ReadInteger(),
